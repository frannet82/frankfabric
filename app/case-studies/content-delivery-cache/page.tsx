  ...
  return (
    <CaseStudy
      ...
      highlights={[
        ...
        {
          title: "Media in step",
          body: "Dynamic-media renditions are flushed alongside the page purge, so imagery and markup never fall out of sync at the edge.",
        },
      ]}
    />
  );
